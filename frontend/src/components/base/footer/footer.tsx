        ...
        <footer className="border-b backdrop-blur-3xl bg-white/80 dark:bg-black/95 shadow-sm
            ...
            <div className="mx-auto px-12">
                <div className="grid gap-12 md:grid-cols-5">
                    <div className="md:col-span-2">
                        <Link
                            ...
                            <span className="text-xl font-bold text-gray-900 dark:text-white">Sneaky</span> 
                ...
                <div className="mt-12 flex flex-wrap items-end justify-between gap-6 border-t py-6">
                    <span className="text-muted-foreground order-last block text-center text-sm md:order-first">© {new Date().getFullYear()} Sneaky, All rights reserved</span>
