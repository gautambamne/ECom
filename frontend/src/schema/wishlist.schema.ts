...
type IProductIdSchema = zodInfer<typeof ProductIdSchema>;
type IWishlistItemResponseSchema = zodInfer<typeof WishlistItemResponseSchema>;
type IWishlistResponseSchema = zodInfer<typeof WishlistResponseSchema>;
type IMoveToCartFromWishlistSchema = zodInfer<typeof MoveToCartFromWishlistSchema>;

export type {
    IAddToWishlistSchema,
    IProductIdSchema,
    IWishlistItemResponseSchema,
    IWishlistResponseSchema,
    IMoveToCartFromWishlistSchema
}
